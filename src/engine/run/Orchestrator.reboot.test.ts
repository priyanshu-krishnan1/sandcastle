...
import type { SandboxService } from "../sandbox/SandboxFactory.js";
import { SandboxFactory } from "../sandbox/SandboxFactory.js";
import { makeLocalSandbox } from "../sandbox/testSandbox.js";
import { agentStreamEmitterLayer } from "../display/AgentStreamEmitter.js";
import { SilentDisplay, type DisplayEntry } from "../display/Display.js";
...
const makeTestSandboxFactory = (
  ...
  return Layer.succeed(SandboxFactory, {
    withSandbox: <A, E, R>(
      makeEffect: (
        info: import("../sandbox/SandboxFactory.js").SandboxInfo,
        sandbox: SandboxService,
      ) => Effect.Effect<A, E, R>,
    ): Effect.Effect<
      import("../sandbox/SandboxFactory.js").WithSandboxResult<A>,
      E | DockerError,
      R
    > =>
